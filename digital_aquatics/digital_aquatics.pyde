...
class Aquatic {
  ...
  drawIrisPupil(self, pupilx, pupily, pupilsize) {
  ...
  drawEyeLid(self, eyex, eyey, eyesize) {
  ...
  superShape(self, m, n1, n2, n3, a, b, radius, start, stop, xoff, yoff, 
             xdistort, cw, mode) {
  ...
  drawAquatic() {
    ...
    let n1 = -0.8 + random(5) * (random(1) < 0.5 ? -1 : 1);
    let n2 = 0.5 + random(5);
